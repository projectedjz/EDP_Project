...
function Navbar() {
  ...
  const navItems = [
    ...
    { label: "Session", path: "/sessions", icon: <DashboardOutlinedIcon /> },
    { label: "Product", path: "/products", icon: <DashboardOutlinedIcon /> },
    { label: "Orders", path: "/orders", icon: <DashboardOutlinedIcon /> },
    { label: "Payment Tracking", path: "/paymentTrackings", icon: <DashboardOutlinedIcon /> },
    { label: "Support", path: "/supports", icon: <DashboardOutlinedIcon /> },
  ];
