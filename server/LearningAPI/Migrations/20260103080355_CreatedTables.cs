        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AffectedTable = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CustType = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductImg = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GBLSessions", x => x.SessionId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_GBLSessions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_GBLSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "GBLSessions",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaymentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    PaidBy = table.Column<DateTime>(type: "datetime", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentTrackings", x => x.PaymentId);
                    table.ForeignKey(
                        name: "FK_PaymentTrackings_GBLSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "GBLSessions",
                        principalColumn: "SessionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentTrackings_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GBLSessions_CartId",
                table: "GBLSessions",
                column: "CartId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GBLSessions_UserId",
                table: "GBLSessions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTrackings_OrderId",
                table: "PaymentTrackings",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentTrackings_SessionId",
                table: "PaymentTrackings",
                column: "SessionId");
